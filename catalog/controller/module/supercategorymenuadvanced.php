...
class ControllerModuleSuperCategoryMenuAdvanced extends Controller {
    public function index($setting) {
        ...
        if (!isset($this->request->get['a'])) {
            ...
            if (file_exists($DIR_MY_STYLES . $template_styles . '/advancedmenu.css')) {
                $this->document->addStyle($DIR_MY_STYLES . $template_styles . '/advancedmenu.css');
            } //file_exists($DIR_MY_STYLES . $template_styles . '/advancedmenu.css')
            else {
                $this->document->addStyle($DIR_MY_STYLES . 'default/advancedmenu.css');
            }
            if (($settings_module['general_data']['rtl_lang'])) {
                $this->document->addStyle('catalog/view/javascript/advancedmenu/advancedmenu_rtl.css');
            } //($settings_module['general_data']['rtl_lang'])
            if (isset($settings_module['styles']['skin_slider'])) {
                $this->document->addStyle('catalog/view/javascript/advancedmenu/slider/skins/' . $settings_module['styles']['skin_slider'] . '.css');
            } //isset($settings_module['styles']['skin_slider'])
            else {
                $this->document->addStyle('catalog/view/javascript/advancedmenu/slider/skins/jslider.yellow.classic.css');
            }
    ...
    public function CreateMenu($what, $id, $settings_module) {
        ...
        if (isset($settings_module['ajax']['loader'])) {
            ...
            if ($settings_module['ajax']['loader_image']) {
